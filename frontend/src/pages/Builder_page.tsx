...
import { Plus, Trash2, Edit3, Download, User, Briefcase, GraduationCap, Award, Code, FolderOpen, Settings, Eye, X, Lightbulb, Check } from 'lucide-react';
...
export default function ResumeBuilder() {
    ...
    const handleDownload = () => {
        ...
        const msg = isMobile
            ...
            : `Tip: The number of pages while printing pdf may have some blank ones so, set “Pages” to 1–1 to print only the first page.`;
    ...
    const renderEditorContent = () => {
        switch (activeSection) {
            ...
            case 'summary':
                return (
                    <div className="space-y-4">
                        <h3 className="text-xl font-medium text-resume-primary dark:text-resume-secondary mb-6">Professional Summary</h3>
                        <div>
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-medium text-center text-resume-primary dark:text-resume-secondary">Technical Skills</h3>
                <button
                    onClick={addSkillCategory}
                    className="flex items-center gap-2 px-3 py-1 text-sm bg-resume-primary text-white rounded-md hover:bg-resume-primary/90 dark:bg-resume-secondary dark:hover:bg-resume-secondary/90 transition-colors"
                >
                    <Plus size={16} />
                    Add Category
                </button>
    ...
    return (
        <>
            <Header />
            <div className="flex flex-col bg-gray-50 dark:bg-[rgba(6,13,35,1)] pt-20">
                {/* Left Panel - Editor */}
                <div className="w-full bg-white dark:bg-[rgba(6,13,35,1)] border-r border-gray-200 border-b flex flex-col">
                    {/* Header with tabs and download button */}
                    <div className="p-4 border-b border-gray-200 bg-gray-50 dark:bg-[rgba(6,13,35,1)]">
                    ...
                    <div className="flex-1 overflow-y-auto">
                        {activeTab === 'editor' ? (
                            <div className="flex flex-col">
                                {/* Section Navigation */}
                                <div className="w-full bg-gray-50 dark:bg-[rgba(6,13,35,1)] sm:border-r sm:border-b border-t border-b border-gray-200 p-6">
            ...
            <div className="flex-1 flex justify-center items-center p-4 lg:p-8 overflow-y-auto dark:bg-[rgba(6,13,35,1)]">
                <style>
                    {`
                        .resume-page {
                ...
                <div id="resume-preview" className="space-y-8 sm:w-auto w-full">
                    ...
                    >
                        ...
                        <div className="text-center border-b-2 border-gray-800 pb-4 mb-6 resume-section">
                            ...
                            >
                                {/* Email with mailto link - hidden in print */}
                                <a
                                ...
                                {/* Email as plain text - only visible in print */}
