...
import { AlertTriangle, FileText, Loader2, Settings, Upload } from "lucide-react";
    ...
    <Layout>
      <div className="container mx-auto px-4 py-12 " >
        <div className="max-w-4xl mx-auto">
          ...
          {/* Analysis Format Notice - Shows after file upload */}
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mb-4">
              <div className="flex items-start gap-3">
                <AlertTriangle className="h-5 w-5 text-amber-600 dark:text-amber-400 mt-0.5 flex-shrink-0" />
                <div className="flex-1">
                  <p className="text-xl font-medium text-amber-800 dark:text-amber-200 mb-2">
                    Analysis Note
                  </p>
                  <p className="text-sm text-amber-700 dark:text-amber-300 mb-3">
                    This tool works best with standard resume formats. Some content may be
                    incorrectly identified as projects. For most accurate analysis, consider
                    using our recommended resume format.
                  </p>
