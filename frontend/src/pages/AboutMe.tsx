    ...
    <div className="min-h-screen py-16 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-2xl shadow-md mb-12 text-center">
          ...
          <a
            href="upi://pay?pa=rahulmall@okicici&pn=Rahul%20Mall&cu=INR"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div className="flex justify-center items-center">
            <Button className="bg-yellow-600 hover:bg-yellow-700 text-white text-lg px-6 py-3 rounded-full flex items-center gap-2">
